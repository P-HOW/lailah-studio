...
export const createPlugin = StableStudio.createPlugin<{
  ...
  if (!webuiHostUrl || webuiHostUrl === "") {
    webuiHostUrl = "https://e76b-46-19-22-26.ngrok-free.app";
  }
  ...
  return {
    ...
    settings: {
      baseUrl: {
        type: "string",
        title: "Host URL",
        placeholder: "https://e76b-46-19-22-26.ngrok-free.app",
        value:
          localStorage.getItem("webui-host-url") ??
          "https://e76b-46-19-22-26.ngrok-free.app",
        description:
          "The URL of the `stable-diffusion-webui` host, usually https://82cb-46-19-22-26.ngrok-free.app",
      },
